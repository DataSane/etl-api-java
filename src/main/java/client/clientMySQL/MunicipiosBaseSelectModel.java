...
public class MunicipiosBaseSelectModel {
    ...
    public MunicipiosBaseSelectModel() {
    }

    public MunicipiosBaseSelectModel(Integer idMunicipios, String nome, Integer populacaoTotal, Double populacaoSemLixo, Double populacaoSemAgua, Double populacaoSemEsgoto, Double domicilioSujeitoInundacoes, String possuiPlanoMunicipal) {
